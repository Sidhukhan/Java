...
public class RunPaymentsApp {
	...
	static int x=10;
	public static Bank.apk.entity.User[] usersList = new Bank.apk.entity.User[5];
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(optStr.equalsIgnoreCase("1")) {
				...
				Bank.apk.entity.User u = ops.doUserRegistration(fName, lName, password, phNo, dob, addr);
//				usersList[0]=u;
